...
export default function ReviewPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      // Fetch 5m data from review endpoint
      try {
        const reviewUrl = buildApiUrl(`/api/dev/stock-results/review/prices?ticker=${ticker}`);
        ...
        const data5m = (await res.json()) as PriceRow[];
